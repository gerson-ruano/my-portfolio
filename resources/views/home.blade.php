...
@section('content')
    ...
    <div class="{{ 'nav-bar-section-a rounded-lg' }} pt-4" id="header-img">
        ...
        <div id="heading" class="px-10 py-20 text-center">
            ...
            <p class="mb-6 text-lg font-normal text-white lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">¡Hola, soy {{ $adminProfile->name }} {{ $adminProfile->description }} En esta web encontrarás muchos de mis proyectos en los que he trabajado y tecnologías con las que he
