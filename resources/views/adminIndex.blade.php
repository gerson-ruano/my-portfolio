...
@foreach ($works as $work)
    ...
    <div class="p-5">
        ...
        <p class="mb-4 font-normal text-gray-700 dark:text-gray-400">{{$work->description}}</p>
          ...
          <a href="{{route('admin.edit')}}" class="inline-flex items-center mr-2 py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
